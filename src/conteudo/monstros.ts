...
export const MONSTROS: DefMonstro[] = [
  // ─── Inimigos comuns ──────────────────────────────────────────────────────
  {
    id: "bit-slime", nome: "Grub Binário", icone: "🐛", familia: "slime", elemento: "nenhum",
  ...
  {
    id: "icone-zumbi", nome: "Espectro Zumbi", icone: "👻", familia: "icone", elemento: "nenhum",
  ...
  {
    id: "cursor-selvagem", nome: "Raposa Neon", icone: "🦊", familia: "cursor", elemento: "nenhum",
  ...
  {
    id: "popup", nome: "Morcego Viral", icone: "🦇", familia: "popup", elemento: "nenhum",
  ...
  // ─── Bosses de área ───────────────────────────────────────────────────────
  {
    id: "a-lixeira", nome: "Leviatã de Dados", icone: "🐲", familia: "boss", elemento: "nenhum",
  ...
  {
    id: "cursor-chefe", nome: "Lobo Corrompido", icone: "🐺", familia: "boss", elemento: "raio",
  ...
  {
    id: "popup-gigante", nome: "Verme do Abismo", icone: "🪱", familia: "boss", elemento: "nenhum",
  ...
  {
    id: "guardiao-do-espaco", nome: "Golem de Hardware", icone: "⚙️", familia: "boss", elemento: "nenhum",

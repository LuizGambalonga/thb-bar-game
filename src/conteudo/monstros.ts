...
export const MONSTROS: DefMonstro[] = [
  // ─── Inimigos comuns ──────────────────────────────────────────────────────
  {
    id: "grub-binario", nome: "Grub Binário", icone: "🐛", familia: "inseto", elemento: "nenhum",
  ...
  {
    id: "espectro-zumbi", nome: "Espectro Zumbi", icone: "👻", familia: "morto-vivo", elemento: "nenhum",
  ...
  {
    id: "raposa-neon", nome: "Raposa Neon", icone: "🦊", familia: "besta", elemento: "nenhum",
  ...
  {
    id: "morcego-viral", nome: "Morcego Viral", icone: "🦇", familia: "besta", elemento: "nenhum",
  ...
  // ─── Bosses de área ───────────────────────────────────────────────────────
  {
    id: "leviata-dados", nome: "Leviatã de Dados", icone: "🐲", familia: "boss", elemento: "nenhum",
  ...
  {
    id: "lobo-corrompido", nome: "Lobo Corrompido", icone: "🐺", familia: "boss", elemento: "raio",
  ...
  {
    id: "verme-abismo", nome: "Verme do Abismo", icone: "🪱", familia: "boss", elemento: "nenhum",
  ...
  {
    id: "golem-hardware", nome: "Golem de Hardware", icone: "⚙️", familia: "boss", elemento: "nenhum",
